...
--
-- Name: comments_tsv_trigger(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.comments_tsv_trigger() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
...
ALTER FUNCTION public.comments_tsv_trigger() OWNER TO postgres;
...
--
-- Name: comments_tsv_idx; Type: INDEX; Schema: public; Owner: user1
--
...
--
-- Name: comments comments_tsv_update; Type: TRIGGER; Schema: public; Owner: user1
--

CREATE TRIGGER comments_tsv_update BEFORE INSERT OR UPDATE ON public.comments FOR EACH ROW EXECUTE PROCEDURE public.comments_tsv_trigger();
